...
var server = function() {
	...
	for(var category in this.categories) {
		this.categories[category].href = '#/category/' + category;
		for(var id in this.categories[category].videos) {
			var video = this.categories[category].videos[id];
			video.href = '#/video/' + category + '/' + id;

			for(var sec in this.sections) {
				var section = this.sections[sec];
				if(!video.assigned) {
	...
	for(var article in this.news) {
		this.news[article].href = '#/article/' + article;
	}
